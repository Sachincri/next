        ...
        <DashboardLayout>
            <div className="p-4 sm:p-8 space-y-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">Support Issues</h1>
                        <p className="text-gray-500 mt-2 text-sm sm:text-base">Manage and track customer support requests.</p>
                    </div>
                    <div className="flex items-center gap-2 bg-blue-50 text-blue-700 px-4 py-2 rounded-lg border border-blue-100 self-start">
                        <AlertCircle size={20} />
